        ...
        <form onSubmit={(e) => { void handleSubmit(e) }} className="px-5 py-4 space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              maxLength={40}
              autoFocus
              className="w-full border border-border-default rounded-xl px-3 py-2.5 text-sm text-text-primary placeholder:text-text-tertiary focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary/60 transition-all"
            />
          </div>
