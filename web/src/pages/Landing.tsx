        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="flex-1 w-full relative" style={{ minHeight: 420, paddingTop: 24, paddingRight: 40, paddingBottom: 60 }}>
            ...
            <img src="/screenshots/painel.png" alt="Dashboard Ekthos Church"
              loading="eager" className="relative z-30 w-full rounded-2xl border border-black/10"
              style={{ boxShadow: '0 24px 64px rgba(0,0,0,0.22)', display: 'block' }} />
            <img src="/screenshots/pessoas.png" alt="Gestão de pessoas"
              loading="lazy" className="absolute z-40 rounded-xl border border-black/10 transition-transform duration-500 hover:scale-[1.03]"
              style={{ width: '54%', bottom: -24, left: -28, boxShadow: '0 16px 40px rgba(0,0,0,0.24)', transform: 'rotate(-2.5deg)' }} />
            <img src="/screenshots/agenda.png" alt="Agenda da Igreja"
              loading="lazy" className="absolute z-20 rounded-xl border border-black/10 transition-transform duration-500 hover:scale-[1.03]"
              style={{ width: '50%', bottom: -32, right: -28, boxShadow: '0 16px 40px rgba(0,0,0,0.20)', transform: 'rotate(2deg)' }} />
            <img src="/screenshots/ministerios.png" alt="Ministérios e células"
              loading="lazy" className="absolute z-10 rounded-xl border border-black/10 transition-transform duration-500 hover:scale-[1.03]"
              style={{ width: '44%', top: -16, right: -32, boxShadow: '0 12px 32px rgba(0,0,0,0.18)', transform: 'rotate(3deg)' }} />
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-4 gap-10 mb-10">
            <div>
              <div className="mb-4 flex items-center gap-3">
                <img src="/logo/ekthos-church.svg" alt="Ekthos Church"
                  className="h-12 w-auto object-contain"
