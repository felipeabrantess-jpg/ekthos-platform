...
const IgvEmpresariosCadastro   = lazy(() => import('@/pages/IgvEmpresariosCadastro'))
const IgvCelulas               = lazy(() => import('@/pages/IgvCelulas'))
...
const ConsolidacaoFila  = lazy(() => import('@/pages/consolidacao/ConsolidacaoFila'))
    ...
    <AuthProvider>
      ...
      <Suspense fallback={<FullScreenSpinner />}>
        <Routes>
          ...
          {/* ── Kids Check-in — secretária faz check-in via token diário (sem auth, sem Layout CRM) ── */}
          <Route
            path="/kids/checkin/:token"
            element={
              <ErrorBoundary>
                <Suspense fallback={<FullScreenSpinner />}>
                  <KidsCheckin />
          ...
          >
            ...
            <Route path="consolidacao/fila" element={<ErrorBoundary><RoleRoute path="pipeline"><Suspense fallback={<PageLoader />}><ConsolidacaoFila /></Suspense></RoleRoute></ErrorBoundary>} />
