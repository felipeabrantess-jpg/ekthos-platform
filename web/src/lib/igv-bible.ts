...
export const BIBLE_BOOKS: BibleBook[] = [
  ...
  { id: 11, name: '1 Reis',            abbr: '1Rs',  apiSlug: '1+reis',            chapters: 22,  testament: 'old' },
  { id: 12, name: '2 Reis',            abbr: '2Rs',  apiSlug: '2+reis',            chapters: 25,  testament: 'old' },
  { id: 13, name: '1 Crônicas',        abbr: '1Cr',  apiSlug: '1+cronicas',        chapters: 29,  testament: 'old' },
  { id: 14, name: '2 Crônicas',        abbr: '2Cr',  apiSlug: '2+cronicas',        chapters: 36,  testament: 'old' },
  ...
  { id: 19, name: 'Salmos',            abbr: 'Sl',   apiSlug: 'salmos',            chapters: 150, testament: 'old' },
  { id: 20, name: 'Provérbios',        abbr: 'Pv',   apiSlug: 'proverbs',          chapters: 31,  testament: 'old' },
  { id: 21, name: 'Eclesiastes',       abbr: 'Ec',   apiSlug: 'eclesiastes',       chapters: 12,  testament: 'old' },
  { id: 22, name: 'Cantares',          abbr: 'Ct',   apiSlug: 'cantares',          chapters: 8,   testament: 'old' },
  ...
  { id: 25, name: 'Lamentações',       abbr: 'Lm',   apiSlug: 'lamentacoes',       chapters: 5,   testament: 'old' },
  ...
  { id: 52, name: '1 Tessalonicenses', abbr: '1Ts',  apiSlug: '1+tessalonicenses', chapters: 5,   testament: 'new' },
  { id: 53, name: '2 Tessalonicenses', abbr: '2Ts',  apiSlug: '2+tessalonicenses', chapters: 3,   testament: 'new' },
  ...
  { id: 57, name: 'Filemon',           abbr: 'Fm',   apiSlug: 'filemon',           chapters: 1,   testament: 'new' },
  ...
  { id: 66, name: 'Apocalipse',        abbr: 'Ap',   apiSlug: 'apocalipse',        chapters: 22,  testament: 'new' },
]
