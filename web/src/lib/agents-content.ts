...
export const AGENTS_CONTENT: AgentContent[] = [
...

  {
    ...
    Icon:       UserPlus,
    category:   'interno',
    shortDesc:  'Verifica duplicatas e coleta dados de visitantes antes do cadastro.',
    longDesc:   'Conversa com a equipe para coletar nome, telefone e demais dados do visitante. Busca ativamente no banco antes de qualquer afirmação — nunca inventa que verificou. Apresenta possíveis duplicatas com transparência e orienta o responsável para o próximo passo. O cadastro final é concluído pela equipe.',
    howItWorks: [
      'Coleta nome e telefone em linguagem natural',
      'Executa busca real no banco antes de falar sobre duplicatas',
      'Apresenta correspondências encontradas com dados completos',
      'Informa explicitamente quando nenhum registro é encontrado',
      'Não afirma ter verificado o que não verificou',
    ],
